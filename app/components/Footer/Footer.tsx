        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="text-gray-400">
              <li className="mb-2"><a href="#" className="hover:text-gray-200 transition duration-300 ease-in-out">Home</a></li>
              <li className="mb-2"><a href="#" className="hover:text-gray-200 transition duration-300 ease-in-out">Services</a></li>
              <li className="mb-2"><a href="#" className="hover:text-gray-200 transition duration-300 ease-in-out">Portfolio</a></li>
              <li className="mb-2"><a href="#" className="hover:text-gray-200 transition duration-300 ease-in-out">Join us</a></li>
            </ul>
          </div>
